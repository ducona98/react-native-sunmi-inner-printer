...
mRemote.transact(Stub.TRANSACTION_postPrintData, _data, _reply, 0);
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getPrinterPaper, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getDrawerStatus, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
